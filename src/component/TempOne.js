...
const TempOne = () => {
    ...
    const [resumeData, setresumeData]=useState({
      ...
      const {firstName,lastName,role,education,email,experience,linkedIn,phone,softskills,summary,techskills} = resumeData
        ...
        <div className="container" id='doc' >
            <div className="row">
                <div className="col-md-4">
                    <h1 className="fullName" style={{
                        fontSize:"28px",lineHeight:"26px"

                    }}>
                        {firstName}<br/>
                        {lastName}
                    </h1>
                    <p style={{ fontSize: '1.5rem' }}>{role.toUpperCase()}</p>
                    <br />
